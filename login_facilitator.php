<?php
// Facilitator login posts to login.php
?>
<!doctype html>
<html>
<head>
    ...
    <title>Facilitator Login - Tanglaw LMS</title>
    <link rel="stylesheet" href="assets/css/style.css">
    <style>
        :root{--card-bg:#fff;--accent:#059669;--muted:#6b7280}
        ...
        .brand .logo{width:40px;height:40px;border-radius:8px;background:linear-gradient(135deg,var(--accent),#047857);color:#fff;display:flex;align-items:center;justify-content:center}
        h2{margin:0 0 6px 0}
    ...
    <div class="card">
        <div class="brand">
            ...
            <div>
                ...
                <p class="lead">Enter your provider/facilitator ID to continue</p>
            </div>
        </div>
        <form method="POST" action="login.php">
            <input type="hidden" name="role" value="facilitator">
            <div class="form-group">
                <label for="username_fac">ID Number</label>
                <input type="text" id="username_fac" name="username" placeholder="e.g., F001" required autofocus>
            </div>
